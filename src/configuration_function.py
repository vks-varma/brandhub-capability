...
feat_eng_config = {
    "weights_model" : {
        "DV" : "market_share_total_sales" if refresh_config["dv"] == "market_share" else refresh_config["dv"],
        "Temp" : 'new_brand',
        "hyperparameters" : {
            "RandomForest" : {
                "grid_search" : {
        ...
        "pillars_list": [pillar.replace("_pillar", "") for pillar in (refresh_config["pillars"]["all_category_pillars"] + refresh_config["pillars"]["by_category_pillars"])],
        "Force_cols" : ['rms_acv_selling_rt','average_price_rt','daily_users_pet_owners_mc','infrequent_users_pet_owners_mc','nps_detractors_pet_owners_mc','nps_passives_pet_owners_mc','nps_promoters_pet_owners_mc','total_aware_all_respondents_mc','total_buzz_pet_owners_mc','total_considering_pet_owners_mc','total_distrust_pet_owners_mc','total_favorable_pet_owners_mc','total_good_value_pet_owners_mc','total_not_considering_pet_owners_mc','total_poor_value_pet_owners_mc','total_trust_pet_owners_mc','total_unfavorable_pet_owners_mc','weekly_users_pet_owners_mc'],
        "Force_cols_net" : ['rms_acv_selling_rt','average_price_rt','daily_users_pet_owners_mc','infrequent_users_pet_owners_mc','net_buzz_pet_owners_mc','net_favorability_pet_owners_mc','net_promoter_score_pet_owners_mc','net_purchase_consideration_pet_owners_mc','net_trust_pet_owners_mc','net_value_pet_owners_mc','total_aware_all_respondents_mc'],
    ...
    "cfa" : {
        ...
        "pillars" : {
            "by_category_pillars" : refresh_config["pillars"]["by_category_pillars"],
            "all_category_pillars" : refresh_config["pillars"]["all_category_pillars"]
        },
